...
\end{center}
\newpage
\part Luego calcule el campo gravitacional a lo largo del mismo eje haciendo derivadas numéricas. 

\begin{center}
	\includegraphics[width=0.85\textwidth]{./accel.pdf}
\end{center}

\part Finalmente encuentre el tiempo que le tomaría a una partícula de masa pequeña en chocar contra el cubo si parte del reposo sobre el eje $z$ y a una distancia de $500\,\textrm{m}$ de la cara más próxima. Para ello resuelva la ecuación de movimiento usando lo encontrado para el campo gravitacional en el anterior literal. 
